...
class Spacelog_UserAnnotationView: MKAnnotationView {
        
    lazy var backgroundView: UIImageView = {
        let view = UIImageView(image: UIImage(named: Constants.Assetname.Images.Symbol.myLocation))
